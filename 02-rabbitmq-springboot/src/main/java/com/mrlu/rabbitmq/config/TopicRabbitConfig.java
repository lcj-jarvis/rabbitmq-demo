...
public class TopicRabbitConfig {
    ...
    public Queue firstQueue(){
        return new Queue("02-rabbitmq-springboot-topic-firstQueue");
    }

    @Bean
    public Queue secondQueue(){
        return new Queue("02-rabbitmq-springboot-topic-secondQueue");
    }

    @Bean
    public Queue thirdQueue(){
        return new Queue("02-rabbitmq-springboot-topic-thirdQueue");
    }
